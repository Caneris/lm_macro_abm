...
class PublicWorker(Agent):

    def __init__(self, _id, A_init, T):
        super(PublicWorker, self).__init__(_id, A_init, T)

        self.routine = False
        self.public_worker = True
...
class Government(Agent):
    ...
    def __init__(self, _id, A_init, T, tau, tau_bar):
        super(Government, self).__init__(_id, A_init, T)

        self.tau, self.tau_bar = tau, tau_bar
        self.debt = 0
        self.W_pw = 0
        # self.wealth_tax_income = 0
        # self.income_tax_income = 0
        self.tax_income = 0
        self.unemp_benefit = 0
        self.paid_benefits = 0
        self.Omega = 0
